...
| ERA5      | 17T             | IAC[<sup>4</sup>](#4) | direct | updated | 1940 - present | 2t, tp, 10si, mn2t, mx2t | monthly, hourly (variable dependent) | 0.25° x 0.25° | [ERA5 at CDS](https://cds.climate.copernicus.eu/cdsapp#!/dataset/reanalysis-era5-single-levels-monthly-means?tab=overview), [Link](https://cds.climate.copernicus.eu/cdsapp#!/dataset/reanalysis-era5-single-levels?tab=overview), need to delete original data after processing because of size |
| ERA5-Land | 40T             | IAC[<sup>5</sup>](#5) | direct | updated | 1950 - present | 2t, snom | hourly (variable dependent) | 0.1° x 0.1° | [ERA5-Land at CDS](https://cds.climate.copernicus.eu/cdsapp#!/dataset/reanalysis-era5-land?tab=form), need to delete original data after processing because of size |

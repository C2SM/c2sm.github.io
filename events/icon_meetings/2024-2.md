...
MJ welcomes everyone and shares the [latest news about ICON from C2SM](https://polybox.ethz.ch/index.php/s/4fXixLycOwOy41K) (<span style="color:darkorange"> **TODO MJ**</span>: update link).
...
### Clarissa Kroll
CK reported that they are getting the ICON XTP (<span style="color:darkorange"> **TODO ML**</span>: ML can you correct? XTP is somehow what I understood but I guess I misunderstood something) setup and plan to merge it with ICON-EXCLAIM. Additionally, they are working on a radiative dumping option.

...
### Clarissa Kroll
CK reported that they are using the icon-seamless/icon-xpp setup and plan to merge it with ICON-EXCLAIM. Additionally, they are working on a radiative dumping option.

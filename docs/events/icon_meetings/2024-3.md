...
### Will Sawyer
WS has been working on benchmarking ICON on the new system. Alps was officially inaugurated on Saturday. WS has benchmarked various versions of ICON and is preparing a presentation: one for this afternoon at EXCLAIM. They can share an early version of the presentation. [Shares presentation](https://polybox.ethz.ch/index.php/s/XIzwjhqBeeB8vN3).

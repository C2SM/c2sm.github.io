...
- Marine heatwaves propagations using an eddy-resolving ocean model, Emma Ferri, ETHZ
...
- Rotationally coherent Lagrangian vortices in eddy-resolving ICON simulations - Stella Berzina, ETHZ
### Session 3

...
-   :material-earth:{ .lg .middle } **Climate Model Data**

    ---

    Raw and processed CMIP archives, such as CMIP6-NextGeneration (CMIP6-ng), hosted at IAC.

    [:octicons-arrow-right-24: Climate Model Data](climate_model_data.md)

-   :material-satellite-variant:{ .lg .middle } **Observational and Re-analysis Datasets**

    ---

    Raw and processed observational and re-analysis archives available at IAC.

    [:octicons-arrow-right-24: Observational and Re-analysis Datasets](obs_reanalysis_data.md)

-   :material-map-outline:{ .lg .middle } **CORDEX-FPSCONV Data**

    ---

    Multi-model ensemble of convection-permitting regional climate model runs over the ALP-3 domain.

    [:octicons-arrow-right-24: CORDEX-FPSCONV Data](cordex_fpsconv_data.md)

-   :material-cube-outline:{ .lg .middle } **ECMWF Data Cube**

    ---

    Data cube set up on AlpsB, a storage system at the ECMWF Data Center in Bologna.
